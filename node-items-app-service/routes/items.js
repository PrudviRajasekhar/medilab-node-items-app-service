...
const data = [
    ...
    { id: 8, title: 'Have a plate of Dum Biriyani', order: 8, completed: true, createdOn: new Date() },
    { id: 9, title: 'Have a plate of Haleem', order: 9, completed: true, createdOn: new Date() }
];
